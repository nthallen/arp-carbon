...
f = ne_dialg(f, 'add', 0, 1, 'gHCIhk_temps', 'Temps' );
f = ne_dialg(f, 'add', 1, 0, 'pHCIhk_tempsr', 'Roving' );
f = ne_dialg(f, 'add', 1, 0, 'pHCIhk_tempss', 'Sample' );
f = ne_dialg(f, 'add', 1, 0, 'pHCIhk_tempsskin', 'Skin' );
