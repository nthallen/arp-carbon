...
f = ne_dialg(f, 'add', 1, 0, 'pHCIminiminidt_ctrl', 'T ctrl' );
f = ne_dialg(f, 'add', 1, 0, 'pHCIminiminids', 'Status' );
f = ne_dialg(f, 'add', 0, 1, 'gHCIminiminimlpv', 'MINI MLPV' );
f = ne_dialg(f, 'add', 1, 0, 'pHCIminiminimlpvp', 'P' );
f = ne_dialg(f, 'add', 1, 0, 'pHCIminiminimlpvt', 'Temp' );
...
f = ne_dialg(f, 'add', 1, 0, 'pHCIminiminilt', 'Temp' );
f = ne_dialg(f, 'add', 1, 0, 'pHCIminiminilt_ctrl', 'T ctrl' );
...
f = ne_dialg(f, 'add', 1, 0, 'pHCIminiminimdpvt', 'Temp' );
...
f = ne_dialg(f, 'add', 1, 0, 'pHCIisoisodt', 'T ctrl' );
f = ne_dialg(f, 'add', 1, 0, 'pHCIisoisodtemp', 'Temp' );
f = ne_dialg(f, 'add', 0, 1, 'gHCIisoisodpv', 'ISO DPV' );
f = ne_dialg(f, 'add', 1, 0, 'pHCIisoisodpvp', 'P' );
f = ne_dialg(f, 'add', 1, 0, 'pHCIisoisodpvt', 'Temp' );
...
f = ne_dialg(f, 'add', 1, 0, 'pHCIisoisoilpvt', 'Temp' );
f = ne_dialg(f, 'add', 1, 0, 'pHCIisoisoilpvrh', 'RH' );
f = ne_dialg(f, 'add', 0, 1, 'gHCIisoisoiqcl', 'ISO IQCL' );
f = ne_dialg(f, 'add', 1, 0, 'pHCIisoisoiqclp', 'P' );
f = ne_dialg(f, 'add', 1, 0, 'pHCIisoisoiqclt', 'Temp' );
f = ne_dialg(f, 'add', 1, 0, 'pHCIisoisoiqclrh', 'RH' );
f = ne_dialg(f, 'add', 0, 1, 'gHCIisoisol', 'ISO Laser' );
f = ne_dialg(f, 'add', 1, 0, 'pHCIisoisolc', 'Current' );
f = ne_dialg(f, 'add', 1, 0, 'pHCIisoisolp', 'P' );
f = ne_dialg(f, 'add', 1, 0, 'pHCIisoisolt', 'Temp' );
f = ne_dialg(f, 'add', 1, 0, 'pHCIisoisolt_ctrl', 'T ctrl' );
f = ne_dialg(f, 'add', 1, 0, 'pHCIisoisols', 'Status' );
f = ne_dialg(f, 'newcol');
f = ne_dialg(f, 'add', 0, 1, 'gHCIisoisop', 'ISO Pump' );
f = ne_dialg(f, 'add', 1, 0, 'pHCIisoisops', 'Status' );
f = ne_dialg(f, 'add', 1, 0, 'pHCIisoisopt', 'Temp' );
