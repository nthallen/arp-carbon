...
regions={'R1','R2','R3','R5'}; % List of regions to load
suffix={'3p3e'}; % List of suffix to load, usally just one but could be more. 
OFILE='ISO130828.1.L2a.mat'; % Output file name
linen=[1,4]; % List of lines to load. Line numbers are same as in mixlines
